 ...
 *
 * The project's quiet ink-mist surfaces need a visible keyboard focus state
 * beyond Material3's ripple. [becalmFocusRing] overlays an explicit 2dp muted
 * accent border so the Focus Visible WCAG 2.4.7 contract holds across light
 * surfaces and the dark alternate.
 *
