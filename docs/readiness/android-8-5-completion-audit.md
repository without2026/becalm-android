...
| Keep Android deterministic gates green | `Android Deterministic Gates` run `25879240085`, conclusion `success` |
| Keep Android tests green | `Android Tests` run `25879240108`, conclusion `success` |
| Verify emulator instrumentation | `instrumented-tests` job in run `25879240108`, conclusion `success` |
| Verify release smoke | `release-smoke` job in run `25879240108`, conclusion `success` |
| Verify unit tests | `unit-tests` job in run `25879240108`, conclusion `success` |
| Verify backend optional tests | `backend-tests` job in run `25879240108`, conclusion `success` |
| Verify staging deploy does not block main | `Deploy Staging` run `25879172966`, conclusion `success` |
...
| Verify readiness smoke survives test APK cleanup | Run `25879240108` reinstalled `app-debug.apk` when `pm path com.becalm.android` was missing, then measured launch/memory/logcat |
...
|---|---:|---|---|
| Android Deterministic Gates | `25879240085` | `e33e544` | success |
| Android Tests | `25879240108` | `e33e544` | success |
| Deploy Staging | `25879172966` | `e33e544` | success |
...
Readiness smoke artifact from `Android Tests` run `25879240108`:

| Metric | Result |
|---|---:|
| App install recovery | `package_installed=missing`, then `app-debug.apk` install `Success` |
| Cold start | `1969ms`, threshold `<=3000ms`, pass |
| Total PSS | `146244KB`, threshold `<=262144KB`, pass |
...
| android-unit-test-reports | 339,686 bytes |
| android-instrumented-test-reports | 891,361 bytes |
