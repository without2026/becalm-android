 ...
 *
 * Four terminal states, computed from the seven user-facing sources:
 ...
 * 2. Any source in SYNCING → [OverallSyncState.Syncing(count, 7)].
...
internal fun deriveOverallState(sources: List<SourceStatus>): OverallSyncState {
    ...
    val total = SourceType.PRODUCT_SOURCES.size
