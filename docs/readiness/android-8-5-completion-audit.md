...
| Keep Android deterministic gates green | `Android Deterministic Gates` run `25870504542`, conclusion `success` |
| Keep Android tests green | `Android Tests` run `25870504458`, conclusion `success` |
| Verify emulator instrumentation | `instrumented-tests` job in run `25870504458`, conclusion `success` |
| Verify release smoke | `release-smoke` job in run `25870504458`, conclusion `success` |
| Verify unit tests | `unit-tests` job in run `25870504458`, conclusion `success` |
| Verify backend optional tests | `backend-tests` job in run `25870504458`, conclusion `success` |
| Verify staging deploy does not block main | `Deploy Staging` run `25870500655`, conclusion `success` |
...
|---|---:|---|---|
| Android Deterministic Gates | `25870504542` | `c76fbc1` | success |
| Android Tests | `25870504458` | `c76fbc1` | success |
| Deploy Staging | `25870500655` | `c76fbc1` | success |
...
| android-unit-test-reports | 332,986 bytes |
| android-instrumented-test-reports | 873,778 bytes |
